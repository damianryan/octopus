...
data class Property(
    ...
    @JsonProperty("electricity_meter_points") val electricityMeterPoints: List<ElectricityMeterPoint>,
    @JsonProperty("gas_meter_points") val gasMeterPoints: List<GasMeterPoint>
)
