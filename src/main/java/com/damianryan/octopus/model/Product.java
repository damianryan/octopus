...
public class Product implements Comparable<Product> {
    ...
    Map<String, Map<String, Tariff>> dualRegisterElectricityTariffs;

    @JsonProperty("single_register_gas_tariffs")
    Map<String, Map<String, Tariff>> singleRegisterGasTariffs;

    @JsonProperty("sample_quotes")
    Map<String, Map<String, SampleQuote>> sampleQuotes;
